...
//  CenteredFont.h
//
//  Created by David Haylock on 16/02/2018.
//

#ifndef CenteredFont_h
#define CenteredFont_h

#pragma once

#include "ofMain.h"

class CenteredFont : public ofTrueTypeFont
{
	public:
		 ...
		 */
		//-----------------------------------------------------
		void drawCenteredBoundingBox(string s, float x, float y, float padding = 5)
		{
			ofRectangle r = getStringBoundingBox(s, 0, 0);
			r.x -= padding;
			r.y -= padding;
