...
void ofxMercatorMap::setScreenDimensions(float _mapScreenWidth, float _mapScreenHeight) {
...
//--------------------------------------------------------------
void ofxMercatorMap::update(float _leftLongitude, float _bottomLatitude, float _rightLongitude, float _topLatitude) {
